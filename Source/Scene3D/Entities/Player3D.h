...
public:
	...
	bool DischargeWeapon(bool spray) const;
	...
	void ProcessStanceChange(PLAYER_STANCE newStance);

	PLAYER_STANCE GetPlayerStance();
...
protected:
	...
	float YHeightAtLocation(glm::vec3 position);
};
